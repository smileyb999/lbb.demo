...
(function () {
  ...
  if (!REDUCED && typeof Lenis !== 'undefined') {
    lenis = new Lenis({ lerp: 0.12, wheelMultiplier: 1, smoothWheel: true, smoothTouch: false });
    window.lenis = lenis;
  }
  ...
  (function () {
    ...
    (function(){var m=document.querySelector('meta[name="theme-color"]');if(m)m.parentNode.removeChild(m);})();
